...
{	
	...
	if(!m_wndTab.Create(WS_CHILD|WS_VISIBLE|/*CTCS_AUTOHIDEBUTTONS|*/CTCS_FOURBUTTONS|CTCS_DRAGMOVE|CTCS_TOP|CTCS_CLOSEBUTTON,CRect(0,0,0,m_nHeight),this,IDC_TABCTRL))
	{
