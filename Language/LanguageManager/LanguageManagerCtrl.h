...
#if !defined(AFX_LANGUAGEMANAGERCTRL_H__38737459_BCD2_485D_B9F8_D640F071DB33__INCLUDED_)
#define AFX_LANGUAGEMANAGERCTRL_H__38737459_BCD2_485D_B9F8_D640F071DB33__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// LanguageManagerCtrl.h : header file
//
...
/////////////////////////////////////////////////////////////////////////////
// CLanguageManagerCtrl window

class AFX_EXT_CLASS CLanguageManagerCtrl
{
// Construction
public:
	CLanguageManagerCtrl();
	virtual ~CLanguageManagerCtrl();
...
public:
	...
	void	InitLanguages(CString& rstrLangDir, bool bReInit = false);
	void	FreeLangDLL();
	void	InitLanguageDir();
	CString& GetLangDir();
	...
	CString	GetResString(/*HINSTANCE _hLangDLL, */UINT uStringID, WORD languageID);
	CString	GetResString(/*HINSTANCE _hLangDLL, */UINT uStringID);
};

/////////////////////////////////////////////////////////////////////////////

#endif // !defined(AFX_LANGUAGEMANAGERCTRL_H__38737459_BCD2_485D_B9F8_D640F071DB33__INCLUDED_)
